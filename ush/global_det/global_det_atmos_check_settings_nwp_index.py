#!/usr/bin/env python3
'''
Name: global_det_atmos_check_settings_nwp_index.py
...
Run By: scripts/stats/global_det/exevs_stats_global_det_atmos_grid2grid_nwp_index.sh
        scripts/plots/global_det/exevs_plots_global_det_atmos_grid2grid_nwp_index.sh
'''
...
if evs_run_mode == 'production':
    evs_global_det_atmos_settings_dict['evs'] = [
        ...
        'pid', 'OUTPUTROOT', 'DATA', 'machine', 'nproc',
