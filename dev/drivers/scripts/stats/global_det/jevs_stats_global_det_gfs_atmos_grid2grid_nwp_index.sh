#PBS -N jevs_stats_global_det_gfs_atmos_grid2grid_nwp_index
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDCOM=YES
export KEEPDATA=NO
export job=${PBS_JOBNAME:-jevs_stats_global_det_gfs_atmos_grid2grid_nwp_index}
