#PBS -N jevs_stats_global_det_aifs_atmos_grid2grid_persistence_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDMAIL=YES
export KEEPDATA=NO
export job=${PBS_JOBNAME:-jevs_stats_global_det_aifs_atmos_grid2grid_persistence}
...
export COMIN=/lfs/h2/emc/vpppg/noscrub/qi.shi/EVS_ecmwf_aifs/$NET/$evs_ver_2d
...
#          atmospheric grid-to-grid component for ECMWF-AIFS
######################################################################
