#PBS -N jevs_stats_global_det_aifs_atmos_grid2grid_nwp_index
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDCOM=YES
export KEEPDATA=NO
export job=${PBS_JOBNAME:-jevs_stats_global_det_aifs_atmos_grid2grid_nwp_index}
...
export REFERENCENAME=aifs_pers

export DATAROOT=/lfs/h2/emc/stmp/$USER/evs_test/$envir/tmp
export TMPDIR=$DATAROOT
export COMIN=/lfs/h2/emc/vpppg/noscrub/$USER/$NET/$evs_ver_2d
export COMINaifs=/lfs/h2/emc/vpppg/noscrub/qi.shi/EVS_ecmwf_aifs/$NET/$evs_ver_2d
