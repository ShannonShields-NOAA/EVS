#PBS -N jevs_plots_global_det_atmos_grid2grid_nwp_index_00_last31days
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export KEEPDATA=NO
export SENDDBN=NO
export job=${PBS_JOBNAME:-jevs_plots_global_det_atmos_grid2grid_nwp_index_00_last31days}
...
#          atmospheric grid-to-grid NWP Index for last 31 days 00Z
######################################################################
