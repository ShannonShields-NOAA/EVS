#PBS -N jevs_plots_global_det_atmos_grid2grid_nwp_index_12_last90days
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=00:10:00
#PBS -l place=vscatter:exclhost,select=1:ncpus=10:ompthreads=1:mem=150GB
#PBS -l debug=true
...
export KEEPDATA=NO
export SENDDBN=NO
export job=${PBS_JOBNAME:-jevs_plots_global_det_atmos_grid2grid_nwp_index_12_last90days}
...
#          atmospheric grid-to-grid NWP Index for last 90 days 12Z
######################################################################
