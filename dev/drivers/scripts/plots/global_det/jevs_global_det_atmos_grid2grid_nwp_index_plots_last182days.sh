#PBS -N jevs_global_det_atmos_grid2grid_nwp_index_plots_last182days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export KEEPDATA=YES
export SENDDBN=NO
export job=${PBS_JOBNAME:-jevs_global_det_atmos_grid2grid_nwp_index_plots_last182days}
...
#          atmospheric grid-to-grid NWP Index for last 90 days
######################################################################
