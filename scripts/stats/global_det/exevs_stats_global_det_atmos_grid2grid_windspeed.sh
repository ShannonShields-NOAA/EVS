#!/bin/bash
###############################################################################
# Name of Script: exevs_stats_global_det_atmos_grid2grid_windspeed.sh
...
for group in reformat_data assemble_data generate_stats gather_stats; do
    ...
    python $USHevs/global_det/global_det_atmos_stats_grid2grid_create_job_scripts_windspeed.py
    export err=$?; err_chk
